 ...
 */
public class ParcelableArraySerializer extends TypeSerializer {

    public ParcelableArraySerializer(ValueParameterDescriptor field) {
        super(field);
    }
    ...
    public String generateWriteValue() {
        return "writeParcelableArray(" + getFieldName()+ ", 0)";
    }
}
